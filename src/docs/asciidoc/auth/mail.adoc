...
=== 2. 틀린 이메일 형식으로 실패
Http Request
include::{snippets}/send-authorization-mail/fail-by-wrong-email/http-request.adoc[]

Http Response
include::{snippets}/send-authorization-mail/fail-by-wrong-email/http-response.adoc[]
include::{snippets}/send-authorization-mail/fail-by-wrong-email/response-fields.adoc[]

=== 3. 중복된 이메일로 실패
Http Response
include::{snippets}/send-authorization-mail/fail-by-duplicated-email/http-response.adoc[]
