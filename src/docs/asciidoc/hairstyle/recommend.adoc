...
=== 3. 태그에 얼굴형 태그가 없어서 실패
Http Request
include::{snippets}/recommend-hair-style/fail-by-no-face-shape-tag/http-request.adoc[]
Http Response
include::{snippets}/recommend-hair-style/fail-by-no-face-shape-tag/http-response.adoc[]
include::{snippets}/recommend-hair-style/fail-by-no-face-shape-tag/response-fields.adoc[]
...
=== 1. 조회 성공
Http Request
include::{snippets}/recommend-hair-style-by-face-shape/success/http-request.adoc[]
include::{snippets}/recommend-hair-style-by-face-shape/success/request-headers.adoc[]
Http Response
include::{snippets}/recommend-hair-style-by-face-shape/success/http-response.adoc[]
include::{snippets}/recommend-hair-style-by-face-shape/success/response-fields.adoc[]
