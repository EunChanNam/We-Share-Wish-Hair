...
@AllArgsConstructor
public enum Tag {
    H_LONG("긴 머리", NORMAL), MEDIUM("중간 머리", NORMAL), SHORT("짧은 머리", NORMAL), PERM("펌 O", NORMAL),
    ...
    HEART("하트형", FACE_SHAPE), OBLONG("직사각형", FACE_SHAPE), LONG("타원형", FACE_SHAPE), SQUARE("정사각형", FACE_SHAPE), ALL("전체", NORMAL),
    ERROR("No-Tag", NORMAL);
