...
public class CouponReceiveItem extends AppCompatActivity {
    ...
    public CouponReceiveItem(String title, String explanation, String constraint) {
        CouponReceiveTitle.setText(title);
        CouponReceiveExplanation.setText(explanation);
        CouponReceiveConstraint.setText(constraint);
    }
    public CouponReceiveItem() {
    };


//    public void ButtonListenerSet() {
